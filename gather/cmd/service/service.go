...
import (
	...
	grpc "github.com/gw123/echo-app/gather/pkg/grpc"
...
var fs = flag.NewFlagSet("gather", flag.ExitOnError)
...
func Run() {
	...
	// 	recorder := zipkingoopentracing.NewRecorder(collector, false, "localhost:80", "gather")
...
func initGRPCHandler(endpoints endpoint.Endpoints, g *group.Group) {
	...
	g.Add(func() error {
		...
		pb.RegisterGatherServer(baseServer, grpcServer)
