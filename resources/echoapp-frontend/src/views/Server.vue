...
<template>
  <div class="home">
    <div>
      <a-collapse >
        <a-collapse-panel header="连接" key="1">
          <a-form-model ref="ruleForm" :model="authinfo" :rules="rules">
            <a-form-model-item has-feedback label="设备id" prop="address">
              <a-input v-model="authinfo.device_id" autocomplete="off"/>
            </a-form-model-item>
            <a-form-model-item has-feedback label="验证密码" prop="port">
              <a-input v-model="authinfo.password" autocomplete="off"/>
            </a-form-model-item>
          </a-form-model>
        </a-collapse-panel>
      </a-collapse>
